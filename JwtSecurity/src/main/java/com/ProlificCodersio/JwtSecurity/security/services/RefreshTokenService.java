package com.ProlificCodersio.JwtSecurity.security.services;
...
import com.ProlificCodersio.JwtSecurity.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    @Value("${prolific.app.jwtRefreshExpirationMs}")
